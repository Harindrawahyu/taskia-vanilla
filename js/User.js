...
class User {
    ...
    saveUser(userData) {
        ...
        const isDuplicate = this.users.some(user => user.username.toLowerCase() === newUser.username.toLowerCase());
        if (isDuplicate) {
            return {
                success: false,
    ...
    loginUser(usernameByInput) {
        ...
        if (userExists) {
            ...
            return {
                success: false,
                message: 'Username kamu belum terdaftar, Silahkan daftar terlebih dahulu',
